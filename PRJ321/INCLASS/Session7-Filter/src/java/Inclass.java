 ...
 * @author Thaycacac
 */
@WebFilter(filterName = "newFilter", urlPatterns = {"/AddStudent.jsp", "/*"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.ERROR, DispatcherType.INCLUDE})
public class Inclass implements Filter {
...
//            response.getWriter().println("You don't have permission to do this task");
...
//        StirngBufferResponseWrapper myResponse = new StirngBufferResponseWrapper(wrappedRequest, wrappedResponse)
        try {
//            chain.doFilter(wrappedRequest, myResponse); 
        } catch (Throwable t) {
